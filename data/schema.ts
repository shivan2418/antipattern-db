...
const CardsItemSchema = z.object({
  ...
  set: z.string(),
  setName: z.string(),
  setType: z.enum(['core', 'memorabilia', 'expansion', 'starter', 'box', 'masters', 'draft_innovation', 'commander', 'masterpiece', 'duel_deck', 'planechase', 'archenemy', 'premium_deck', 'spellbook', 'from_the_vault', 'arsenal', 'token']),
  setUri: z.string().url(),
